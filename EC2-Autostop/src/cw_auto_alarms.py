...
alarm_cpu_low_threshold = getenv("ALARM_CPU_LOW_THRESHOLD", "10")
...
default_alarms = {
    ...
    'AWS/EC2': [
        ...
        {
            'Key': alarm_separator.join(
                [alarm_identifier, 'AWS/EC2', 'CPUUtilization', 'LessThanThreshold', '5m', 'Minimum', 'default1']),
            'Value': alarm_cpu_low_threshold
        }
    ],
    # 'AWS/Lambda': [
    #     {
